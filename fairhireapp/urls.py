...
from . import views
from fairhireapp.backend import login,complaint, home, about, laws, registeruser, logout, new_complaint, change_complaint_status
...
urlpatterns = [
    ...
    path('logout', logout),
    path('change_complaint_status',change_complaint_status)
    # path('login',login),
    # path('signup',signup),
